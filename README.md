...
| `skills/` | 8 first-party skills — `machine-setup`, `machine-use`, `sandbox-use`, `autoresearch`, `autoresearch-worker`, `autoresearch-hypothesizer`, `planning-with-files`, `witsoc`. |
