...
tools: arxiv__search_papers, arxiv__get_paper, arxiv__download_and_index_paper
...
Download a paper PDF and add it to the searchable index. After indexing, use the search tool to query its contents.
params:
